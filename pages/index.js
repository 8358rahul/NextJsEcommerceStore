...
export default function Home() {
  return (
    <div >
      <Head>
        <title>Ecommerce.com - Wear the code</title>
        <meta name="description" content="Ecommerce.com - Wear the code"/>
        <link rel="icon" href="/favicon.ico" />
      </Head> 

      <div>
        <Image src="/slider.jpg" alt="" width={2000} height={600}/>
      </div>
      <section className="text-gray-600 body-font">
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-wrap w-full mb-20 flex-col items-center text-center">
      <h1 className="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">Ecommerce.com - Wear the code</h1>
      <p className="lg:w-1/2 w-full leading-relaxed text-gray-500">Wear Whatever you want tote bag tumblr hexagon brooklyn asymmetrical gentrify, subway tile poke farm-to-table.</p>
    </div>
